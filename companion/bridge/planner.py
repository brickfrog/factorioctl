...
EXECUTION_PROMPT = (
    ...
    "things, don't just describe them; after building or modifying production, "
    "call verify_production once to confirm entities are WORKING and fix "
    "no_power/no_fuel/no_ingredients/full_output failures. Narrate briefly "
    "with broadcast_thought "
